...
export default class XAxis {
  ...
  drawXaxis() {
    ...
    if (w.globals.hasGroups) {
      ...
      if (w.config.xaxis.group.style) {
        ...
        overwriteStyles.cssClass = w.config.xaxis.group.dashboard.cssClass
      }
    ...
    if (w.config.xaxis.title.text !== undefined) {
      ...
      let elXAxisTitleText = graphics.drawText({
        ...
        cssClass:
          'apexcharts-xaxis-title-text ' + w.config.xaxis.title.dashboard.cssClass
      })
  ...
  drawXAxisLabelAndGroup(
    ...
    const cssClass =
      overwriteStyles.cssClass || w.config.xaxis.labels.dashboard.cssClass
    ...
    if (ylabels.show) {
      for (let i = 0; i <= labels.length - 1; i++) {
        ...
        let elLabel = graphics.drawText({
          ...
          isPlainText: false,
          cssClass: 'apexcharts-yaxis-label ' + ylabels.dashboard.cssClass
        })
    ...
    if (w.config.yaxis[0].title.text !== undefined) {
      ...
      let elXAxisTitleText = graphics.drawText({
        ...
        cssClass:
          ...
          w.config.yaxis[0].title.dashboard.cssClass
      })
